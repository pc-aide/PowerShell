...
(
    ...
    try {
        ...
        return $primaryUser.value."userPrincipalName"
...
if($Devices){
    ...
    foreach($device in $Devices){
            ...
            if($IntuneDevicePrimaryUser -eq $null){
                ...
                Write-Host "No Intune Primary User Id set for Intune Managed Device" $Device."deviceName" -f Yellow 

            }

            else {

                Write-Host "UPN:" $IntuneDevicePrimaryUser
